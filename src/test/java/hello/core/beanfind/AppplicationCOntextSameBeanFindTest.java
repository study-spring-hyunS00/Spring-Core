...
class AppplicationCOntextSameBeanFindTest {
    ...
    void findByBeanName(){
        ...
        Assertions.assertInstanceOf(MemberRepository.class,memberRepository1);
        Assertions.assertInstanceOf(MemberRepository.class, memberRepository2);
    }
